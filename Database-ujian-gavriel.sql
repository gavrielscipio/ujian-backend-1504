...
CREATE TABLE `movies` (
  ...
  PRIMARY KEY (`id`),
  KEY `moviestatus_movies_idx` (`status`),
  CONSTRAINT `moviestatus_movies` FOREIGN KEY (`status`) REFERENCES `movie_status` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `schedules` (
  ...
  KEY `times_schedule_idx` (`time_id`),
  CONSTRAINT `location_schedule` FOREIGN KEY (`location_id`) REFERENCES `locations` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `movies_schedule` FOREIGN KEY (`movie_id`) REFERENCES `movies` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `times_schedule` FOREIGN KEY (`time_id`) REFERENCES `show_times` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `users` (
  ...
  `status` int NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`),
  KEY `roles_users_idx` (`role`),
  KEY `status_users_idx` (`status`),
  CONSTRAINT `roles_users` FOREIGN KEY (`role`) REFERENCES `roles` (`id`),
  CONSTRAINT `status_users` FOREIGN KEY (`status`) REFERENCES `status` (`id`)
...
INSERT INTO `users` VALUES (1,'1612335821341','gavriel','gavriel@gmail.com','gavriel1!',2,1),(2,'1612336298478','sevrian','sevrian@gmail.com','7e807f937facd7cdda8794dce73343ed',2,1),(3,'1612336347903','arthur','arthur@gmail.com','d7740ab80edaa47535cdc87b9aa9384b',2,1),(4,'1612336396004','scipio','scipio@gmail.com','1589d445893cbd81e2cfa0837ac19260',2,1),(5,'1612336427393','bambang','bambang@gmail.com','2c23fa35bc46c455478c9bbbe7cd1fd3',2,1),(6,'1612337313858','chikaa','chika@gmail.com','002e4fc22f2b09da70767af4511b0421',2,1),(7,'1612337363649','anselma','anselma@gmail.com','9a790813d8d4972b60888d1227f08aea',2,3),(8,'1612341961503','admin1','admin@gmail.com','61baed7772afda88b7c2c5433c46602b',1,1);
...
-- Dump completed on 2021-02-03 17:14:56
